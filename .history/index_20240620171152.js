...
const centerPoint = { latitude:  78.3915165, longitude:  78.3915165 };

// Allowable distance (e.g., 50 meters)
const allowableDistance = 500; // in meters
...
app.post('/check-attendance', (req, res) => {
  ...
  const results = students.map(student => {
    const withinBounds = isWithinBounds(student.location, bounds);
    return {
      id: student.id,
      withinBounds
    };
