...
const centerPoint = { latitude: 17.383424, longitude: -118.276736555556 };
...
function isWithinDistance(studentLocation, centerPoint, allowableDistance) {
...
app.post('/check-attendance', (req, res) => {
  ...
  const results = students.map(student => {
    const withinDistance = isWithinDistance(student.location, centerPoint, allowableDistance);
    return {
      id: student.id,
      withinDistance
    };
